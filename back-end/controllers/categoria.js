...
controller.obterUm = async(req,res) => {
    ...
    let obj = await Categoria.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Categoria.findByIdAndUpdate(id, req.body)//Busca o objeto pelo id e, encontrando-o substitui o conteudo por req.body
...
controller.excluir= async (req,res) =>{
   try{
    ...
    const id=req.body._id
    let obj = await Categoria.findByIdAndDelete(id)
