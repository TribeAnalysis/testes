...
controller.listar = async (req, res) => {
    try {
        ...
        let dados = await Despesa.find().populate('categoria', 'nome')
...
controller.obterUm = async(req,res) => {
    ...
    let obj = await Despesa.findById(id)
...
controller.atualizar = async (req, res) => {
    try {
        ...
        let obj = await Despesa.findByIdAndUpdate(id, req.body)//Busca o objeto pelo id e, encontrando-o substitui o conteudo por req.body
...
controller.excluir= async (req,res) =>{
   try{
    ...
    const id=req.body._id
    let obj = await Despesa.findByIdAndDelete(id)
